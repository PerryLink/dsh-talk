...
| Superficie | Estado |
|---|---|
| Harness | DeepSeek Harness `dsh-v0.1.5-alpha.1` (tag de GitHub, verificado el 2026-09-09: cadena completa de gates + smoke de instalación del perfil). Línea de dependencias npm `0.1.2-rc.1`, peers `>=0.1.2-rc.1 <0.2.0 || >=0.1.5-alpha.1 <0.2.0`. |
| Node | `^22.19.0 \|\| >=24.0.0` |
