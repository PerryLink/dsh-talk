...
| सतह | स्थिति |
|---|---|
| Harness | DeepSeek Harness `dsh-v0.1.5-rc.2` (GitHub tag, 2026-09-11 को सत्यापित: पूर्ण gate chain + profile install smoke)। npm निर्भरता लाइन `0.1.5-rc.2`, peers `>=0.1.2-rc.1 <0.2.0 || >=0.1.5-alpha.1 <0.2.0`। |
| Node | `^22.19.0 \|\| >=24.0.0` |
...
- **होस्ट संगतता** — `dsh-talk/speech` इवेंट एक अनुकूली गेट से जोड़ा जाता है। जिन host की ज्ञात-प्रकार शब्दावली इस इवेंट को कवर करती है वे इसे सीधे जोड़ते हैं; `ignorable` विकल्प वाले host इसे मार्कर सहित जोड़ते हैं; एनवलप-रहित host — `0.1.1-rc.2` तक की हर जारी लाइन, `0.1.2-alpha` लाइन, और `0.1.2-rc.1` लाइन, जिसका Session.append ignorable मार्कर स्टैम्प नहीं कर सकता, हालाँकि एनवलप फ़ील्ड पठन संगतता के लिए रखा गया है — कोई append नहीं पाते, इसलिए उन लाइनों पर स्पीच कभी सत्र लॉग को दूषित नहीं कर सकती। वहाँ live playback इतिहास खाली रहता है और speak टूल के परिणाम ही पुनर्निर्माण योग्य निशान हैं।
...
- **एनवलप-रहित host पर live playback इतिहास खाली रहता है**: `0.1.1-rc.2`, `0.1.2-alpha` लाइन, और `0.1.2-rc.1` पर host की शब्दावली `dsh-talk/speech` को नहीं जानती, इसलिए गेट कुछ नहीं लिखता और क्लाइंट की सत्र-स्तरीय playback सूची खाली रहती है। स्पीच स्वयं, माइक, सेटिंग्स टैब और टूल अप्रभावित रहते हैं।
