...
| सतह | स्थिति |
|---|---|
| Harness | DeepSeek Harness `0.1.1-rc.2` (मुख्य लक्ष्य); `0.1.2-alpha.1` पर स्पीच-लॉग गेट सक्रिय रहकर चलता है (ज्ञात सीमाएँ देखें) |
| Node | `^22.19.0 \|\| >=24.0.0` |
...
- **एनवलप-रहित host पर live playback इतिहास खाली रहता है**: `0.1.1-rc.2` और `0.1.2-alpha.1` पर host की शब्दावली `dsh-talk/speech` को नहीं जानती, इसलिए गेट कुछ नहीं लिखता और क्लाइंट की सत्र-स्तरीय playback सूची खाली रहती है। स्पीच स्वयं, माइक, सेटिंग्स टैब और टूल अप्रभावित रहते हैं।
