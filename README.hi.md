...
- **होस्ट संगतता** — स्थायी speech events DSH के ignorable-log-events समर्थन (`52a0ddf597`) पर निर्भर हैं। इस core सुविधा के बिना stock `0.1.0-rc.8` host प्लगइन चला सकता है, लेकिन speech-event session-reload safety घट जाती है; सुरक्षित reload ज़रूरी हो तो इस सुविधा वाला host इस्तेमाल करें।
