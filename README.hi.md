...
- **होस्ट संगतता** — `dsh-talk/speech` session event बिना `ignorable` मार्कर के जोड़ा जाता है, क्योंकि `0.1.1-rc.2` तक का कोई भी जारी DSH host किसी plugin को यह मार्कर सेट करने नहीं देता। `0.1.0-rc.7` से आगे के host ऐसे session log को cold load करने से मना कर देते हैं जिसमें बिना मार्कर वाला अज्ञात event type हो, इसलिए जिस session ने एक बार भी बोला है उसका अगला cold load `SessionFormatUnsupportedError` के साथ विफल होता है। log सुरक्षित है और सुधारा जा सकता है (ज्ञात सीमाएँ देखें)। नियोजित सुधार live playback को session log के बजाय Remote push से ले जाता है और log event केवल उन्हीं host पर लिखता है जो उसे ignorable चिह्नित कर सकते हैं।
...
- **बोलने के बाद session cold load नहीं होता**: `0.1.0-rc.7` या नए host पर, जब session की log में बिना मार्कर वाले `dsh-talk/speech` events हों तो उसका अगला cold load `SessionFormatUnsupportedError` के साथ विफल होता है। सुधार: host रोकें, session की `.jsonl` log का बैकअप लें, हर उस JSON पंक्ति में शीर्ष-स्तर सदस्य के रूप में `"ignorable":true` जोड़ें जिसका `"type"` `"dsh-talk/speech"` है (उदाहरण के लिए, शुरुआती `{` के ठीक बाद `"ignorable":true,` डालें), फिर session दोबारा खोलें। बाकी कुछ नहीं बदलता और कुछ भी खोता नहीं।
