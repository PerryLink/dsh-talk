...
- **होस्ट संगतता** — स्थायी speech events DSH की एक session-log सुविधा (ignorable log-only events) पर निर्भर हैं जो अभी किसी भी जारी DSH में उपलब्ध नहीं है, `0.1.1-rc.2` सहित; यह एक development fork में मौजूद है और upstream प्रस्तावित की जा रही है। इसके बिना host प्लगइन चला सकता है, लेकिन speech-event session-reload safety घट जाती है; plugin को reload-safe केवल उसी host पर मानें जिसमें यह सुविधा हो।
